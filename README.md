...
* [x] Shows progress bars when first loading articles onto a page as well as when loading an individual article in a separate page
* [x] Allows user to set the number of columns for their newspaper query to have in the "Settings" tab of the action bar

## Video Walkthrough

Here's a walkthrough of implemented user stories:

http://i.imgur.com/QobGK2e.gif

<img src='http://i.imgur.com/QobGK2e.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
-Getting the filter feature to work properly and save user's preferences for subsequent searches

## Open-source libraries used

- [Android Async HTTP](https://github.com/loopj/android-async-http) - Simple asynchronous HTTP requests with JSON parsing
- [Glide](http://square.github.io/glide/) - Image loading and caching library for Android
